$(function () {
    ...
    $("#header").append("<div class=\"col-12 text-center\">\n" +
                            "<a href=\"index.html\"><img src=\"/Cleyam/libs/img/logoTitle.png\" id=\"logoFullSize\" class=\"img-fluid mx-auto\" alt=\"Logo retour à l'accueil\" title=\"Cleyam - Retour à l'accueil\"></a>\n" +
                            "<a href=\"index.html\"><img src=\"/Cleyam/libs/img/title.png\" id=\"logoMobile\" class=\"img-fluid\" alt=\"Logo retour à l'accueil\" title=\"Cleyam - Retour à l'accueil\"></a></div>\n" +
                            "<div class=\"col-12\">\n" +
    ...
    $.ajax({
        ...
        for (let loop = 0; loop <= data.length - 1; loop++) {
            $("#gallery").append("<div class=\"col-lg-3 col-md-4 col-xs-6 thumb\"><a href=\"/Cleyam/" + data[loop].link + "\" class=\"fancybox\" rel=\"ligthbox\"><img src=\"/Cleyam/" + data[loop].link + "\"class=\"zoom img-fluid\" alt=\"\"></a></div>")
        }
    });

    // News page content
    $("#newsBody").html("<div class=\"row\"><div class=\"twitterFeed col-3 bg-beige\"><a class=\"twitter-timeline\" href=\"https:\/\/twitter.com\/Itsmecleyam?ref_src=twsrc%5Etfw\">Tweets de Cleyam</a></div> <script async src=\"https://platform.twitter.com/widgets.js\" charset=\"utf-8\"></script><div class=\"col-9\"><h1>Quoi de neuf ?</h1></div></div>")

    // Stream page content
    $("#streamBody").html("<h1>Twitch</h1><iframe src=\"https:\/\/player.twitch.tv\/?channel=cleyam\" frameborder=\"0\" allowfullscreen=\"true\" scrolling=\"no\" height=\"500\" width=\"720\"></iframe><iframe src=\"https:\/\/www.twitch.tv\/embed\/cleyam\/chat\" frameborder=\"0\" scrolling=\"no\" height=\"500\" width=\"350\"></iframe>")
